...
export function TimelineUi() {
  ...
  const textStyle = "text-white dark:text-neutral-200 text-[16px] font-montserrat mb-8";

  const containerStyle = "grid grid-cols-1 gap-4  md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2";
      ...
      content: (
        <div>
          <p className={textStyle}>
            ...
            consequatur dolorum fuga quod assumenda optio minus odio incidunt
            nemo?
          </p>
          <p className={textStyle}>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quisquam
            reiciendis similique dolorem iusto incidunt libero nostrum neque non
            quasi soluta quam possimus harum, consequatur explicabo ea ipsum
            blanditiis nesciunt eligendi.
          </p>
          <div className={containerStyle}>
            <Image
